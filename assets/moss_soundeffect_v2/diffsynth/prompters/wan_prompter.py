...
import os, torch
# MOSS-TTS-V15-ComfyUI patch: ftfy is an optional dependency in the ComfyUI
# runtime; when absent the mojibake fix is skipped (prompts pass through
# whitespace/html cleaning unchanged).
try:
    import ftfy
